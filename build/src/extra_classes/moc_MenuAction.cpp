...
#include <memory>
#include "../../../src/extra_classes/MenuAction.h"
...
QT_INIT_METAOBJECT const QMetaObject MenuAction::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidgetAction::staticMetaObject>(),
    qt_meta_stringdata_MenuAction.data,
    qt_meta_data_MenuAction,
    qt_static_metacall,
    nullptr,
    nullptr
} };
