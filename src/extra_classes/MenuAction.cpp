...
{}
void MenuAction::Create_button(const QString& button_text,const QString& info_text) {
...
void MenuAction::Create_button_with_icon(const QIcon& icon,const QString& button_text,const QString& info_text) {
    m_menuButton = new MenuPushButton(icon,info_text,button_text);
    m_menuButton->setObjectName(m_objectName);
    this->setDefaultWidget(m_menuButton);
}
