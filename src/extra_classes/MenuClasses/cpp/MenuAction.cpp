...
{}
void MenuAction::Create_button(const QString& button_text,std::string info_text) {
...
void MenuAction::Create_button_with_icon(const QIcon& icon,const QString& button_text,std::string info_text) {
